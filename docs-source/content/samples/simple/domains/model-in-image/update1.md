...
1. Ensure that you have a running domain.
    ...
    Make sure you have deployed the domain from the [Initial]({{< relref "/samples/simple/domains/model-in-image/_index.md" >}}) use case.
...
1. Update your domain resource to refer to the ConfigMap and secret.
    ...
    - Option 1: Update a copy of your domain resource file from the Initial use case.
      ...
      - In the [Initial]({{< relref "/samples/simple/domains/model-in-image/_index.md" >}}) use case, we suggested creating a domain resource file named `/tmp/mii-sample/mii-initial.yaml` or using the `/tmp/mii-sample/domain-resources/WLS/mii-initial-d1-WLS-v1.yaml` file that is supplied with the sample.
