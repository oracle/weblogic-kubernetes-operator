...
2. Create an updated image.
   ...
   - Understanding your updated WDT archive.
     ...
     For additional information about archives, see [Understanding your first archive]({{< relref "/samples/simple/domains/model-in-image/_index.md#understanding-your-first-archive" >}}) in the Initial use case.
   ...
   - Understanding your staged model files.
     ...
     If you would like to review the entire original model before this change, see [Staging model files]({{< relref "/samples/simple/domains/model-in-image/_index.md#staging-model-files" >}}) in the Initial use case.
