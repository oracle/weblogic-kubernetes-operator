...
```none
sample-domain1-ns             13m         Normal    NamespaceWatchingStarting   namespace/sample-domain1-ns               Starting watching namespace sample-domain1-ns
...
sample-domain2-ns             8m35s       Normal    NamespaceWatchingStarting   namespace/sample-domain2-ns               Starting watching namespace sample-domain2-ns
...
sample-domain2-ns             18s         Normal    NamespaceWatchingStopping   namespace/sample-domain2-ns               Stopping watching namespace sample-domain2-ns
