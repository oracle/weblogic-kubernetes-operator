...
| `introspectVersion` | string | If the domain is running, the operator will restart its introspector job when this value is changed.This field is ignored when the domainHomeSourceType source type is FromModel. |
