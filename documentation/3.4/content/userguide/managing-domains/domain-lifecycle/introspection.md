...
The operator supports rerunning the introspector to propagate [model updates]({{<relref "/userguide/managing-domains/model-in-image/runtime-updates.md">}}) to a running Model in Image domain.
