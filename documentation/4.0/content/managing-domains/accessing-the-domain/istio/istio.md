...
* For using Istio in Red Hat OpenShift, this operator version 4.0 is only compatible with Red Hat OpenShift version 4.11.x with the latest Service Mesh 2.2.3 and above.  
