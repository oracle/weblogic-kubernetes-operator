...
* Create a Kubernetes Namespace for the domain unless you intend to use the default namespace. Make sure the operator is watching the namespace. For more guidance, see [Configure or dynamically change the namespaces that a running operator manages]({{< relref "/managing-operators/namespace-management" >}}).
