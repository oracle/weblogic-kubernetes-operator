...
| `rolling` | Boolean | True while pods have been intentionally deleted and have not yet returned to the ready state. Defaults to null, which is interpreted as 'false'. |
