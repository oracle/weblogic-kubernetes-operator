...
| `nfs` | [NFS Volume Source](k8s1.28.2.md#nfs-volume-source) | nfs represents an NFS mount on the host. Provisioned by an admin. More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs. Represents an NFS mount that lasts the lifetime of a pod. NFS volumes do not support ownership management or SELinux relabeling. Operator-created PersistentVolumes with NFS sources require the operator Helm chart's domainOnPV.localDeveloperMode setting. |
