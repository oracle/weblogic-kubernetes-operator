...
hugo -s 3.3 -d "${outdir}" -b https://oracle.github.io/weblogic-kubernetes-operator
...
hugo -s 3.2 -d "${outdir}/3.1" -b https://oracle.github.io/weblogic-kubernetes-operator/3.2
