...
cd latest
hugo -d "${outdir}" -b https://oracle.github.io/weblogic-kubernetes-operator
cd ../2.5
hugo -d "${outdir}/2.5" -b https://oracle.github.io/weblogic-kubernetes-operator/2.5
cd ../2.6
hugo -d "${outdir}/2.6" -b https://oracle.github.io/weblogic-kubernetes-operator/2.6
cd ../3.0
hugo -d "${outdir}/3.0" -b https://oracle.github.io/weblogic-kubernetes-operator/2.5
cd ../3.1
hugo -d "${outdir}/3.1" -b https://oracle.github.io/weblogic-kubernetes-operator/2.5
cd ..
