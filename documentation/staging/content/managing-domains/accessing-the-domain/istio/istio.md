...
* For Red Hat OpenShift Service Mesh, continue to use operator version 3.4 or earlier.  This operator version 4.0 is incompatible with the current OpenShift Service Mesh implementation, which is based on Istio version 1.9.
