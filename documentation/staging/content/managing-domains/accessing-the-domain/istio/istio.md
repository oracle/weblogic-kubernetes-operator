...
* For Red Hat OpenShift Service Mesh, continue to use Operator version 3.4 until OpenShift Service Mesh upgraded its own implementation to base on Istio version 1.10 and later.
