...
- See the Domain Custom Resource [reference document](https://github.com/oracle/weblogic-kubernetes-operator/blob/main/documentation/domains/DomainResource.md).
