...
**Note:** For an alternative approach to this sample, see the [WebLogic Server on AKS Marketplace]({{<relref "/userguide/aks/_index.md">}}) offering which automates the provisioning the provisioning of
