...
more information, see [Updating operator external certificates]({{<relref "/userguide/managing-operators/security/certificates#updating-operator-external-certificates">}}).
