...
[^2]: The binding is assigned to the operator `ServiceAccount`
      in each namespace that the operator is configured to manage. See [Managing domain namespaces]({{< relref "/userguide/managing-operators/namespace-management.md" >}})
