...
98s         Warning   DNSConfigForming            pod/sample-domain1-introspector-ght6p   Search Line limits were exceeded, some search paths have been omitted, the applied search line is: sample-domain1-ns.svc.cluster.local svc.cluster.local cluster.local oracle.com
