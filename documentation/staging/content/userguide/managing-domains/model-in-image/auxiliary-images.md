...
### Contents
 ...
 - [Automated upgrade of the weblogic.oracle/v8 schema auxiliary images configuration](#automated-upgrade-of-the-weblogicoraclev8-schema-auxiliary-images-configuration)
   - [Sample weblogic.oracle/v8 schema auxiliary image configuration](#sample-weblogicoraclev8-schema-auxiliary-image-configuration)
   - [Compatibility weblogic.oracle/v9 schema auxiliary image configuration generated by conversion webhook in WKO 4.0](#compatibility-weblogicoraclev9-schema-auxiliary-image-configuration-generated-by-conversion-webhook-in-wko-40)
...
{{% notice note %}}
The automated upgrade described in this section convert `weblogic.oracle/v8` schema auxiliary image configuration into low-level Kubernetes schema, for example, init-containers and volumes. 
As time permits, Oracle recommends using a simplified `weblogic.oracle/v9` schema configuration for the auxiliary images as documented in the [Configuration](#configuration) section instead of relying on the generated low-level schema.
{{% /notice %}}
