...
To manually upgrade the domain resource from the `weblogic.oracle/v8` schema to the `weblogic.oracle/v9` schema, refer to [upgrade the `weblogic.oracle/v8` schema domain resource manually]({{< relref "/userguide/managing-domains/upgrade-domain-resource#upgrade-the-weblogicoraclev8-schema-domain-resource-manually" >}}) section in the [domain resource upgrade]({{< relref "/userguide/managing-domains/upgrade-domain-resource" >}}) document.
