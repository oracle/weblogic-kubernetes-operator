...
| Name | Type | Description |
| --- | --- | --- |
| `matchExpressions` | Array of [Label Selector Requirement](#label-selector-requirement) | matchExpressions is a list of label selector requirements. The requirements are ANDed. |
