...
To run the test classes in parallel, `export PARALLEL=true`
```
...
| PARALLEL   | When set to "true", runs the test classes in parallel. Default is run test classes in sequential |
