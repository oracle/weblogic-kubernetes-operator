...
| Domain with 2 configured cluster created using WLST | Multi Configured cluster |
| Domain with 2 mixed cluster created using WLST | 1 configured and 1 dynamic cluster in domain |
