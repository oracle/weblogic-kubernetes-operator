...
class ItIstioTwoDomainsInImage {
  ...
  void testIstioTwoDomainsWithSingleIngress() {
    ...
    createDomainResource(domainUid1, domainNamespace1, adminSecretName1, BASE_IMAGES_REPO_SECRET_NAME,
        replicaCount);
    createDomainResource(domainUid2, domainNamespace2, adminSecretName2, BASE_IMAGES_REPO_SECRET_NAME,
        replicaCount);
