...
/**
 * Tests to verify MII sample with FMW image.
 */
@DisplayName("Test model in image sample with FMW image")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@IntegrationTest
public class ItMiiFmwSample {
  ...
  public void testCheckFmwSampleSource() {
   ...
   * @see #testFmwInitialUseCase for more...
   */
  @Test
  @Order(2)
