...
( cd ${istiodir}
  ...
  bin/istioctl install --set meshConfig.enablePrometheusMerge=true --set values.global.imagePullSecrets[0]=docker-istio-secret --set hub=gcr.io/istio-release --set components.cni.enabled=true --set profile=demo -y
