...
class Infra12213Provisioner:
    ...
    def __init__(self, oracleHome, javaHome, domainParentDir, adminListenPort, adminName, adminPortEnabled, administrationPort, managedNameBase, managedServerPort, prodMode, managedCount, clusterName):
