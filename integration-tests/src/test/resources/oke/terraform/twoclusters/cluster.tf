...
variable "cluster_name1" { default = "tfTestCluster1" }
variable "cluster_name2" { default = "tfTestCluster2" }
variable "cluster_name" { default = "twoTestClusters" }
...
variable "node_pool_name1" { default = "tfTestCluster_workers1" }
variable "node_pool_name2" { default = "tfTestCluster_workers2" }
