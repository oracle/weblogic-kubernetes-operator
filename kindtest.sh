...
if [ "${test_filter}" != "**/It*" ]; then
  ...
  if [ "${maven_profile_name}" = "fmw-srg" ] || [ "${maven_profile_name}" = "toolkits-srg" ] || [ "${maven_profile_name}" = "wls-image-cert" ] || [ "${maven_profile_name}" = "fmw-pipeline" ] || [ "${maven_profile_name}" = "fmw-image-cert" ] || [ "${maven_profile_name}" = "kind-sequential" ]; then
