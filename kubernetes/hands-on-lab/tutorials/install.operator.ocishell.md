...
```shell
$ git clone --branch $(git ls-remote --tags https://github.com/oracle/weblogic-kubernetes-operator.git v4.0.\* | tail -1 | sed -E 's|.*refs/tags/(.+)|\1|') https://github.com/oracle/weblogic-kubernetes-operator.git
```
