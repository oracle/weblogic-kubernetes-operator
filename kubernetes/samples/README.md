...
* [Sample for creating a WebLogic domain home on an existing PV or PVC (Domain in PV)](https://oracle.github.io/weblogic-kubernetes-operator/samples/simple/domains/domain-home-on-pv/), and the domain resource YAML file for deploying the generated WebLogic domain.
* [Sample for creating a WebLogic domain home inside a Docker image (Domain in Image)](https://oracle.github.io/weblogic-kubernetes-operator/samples/simple/domains/domain-home-in-image/), and the domain resource YAML file for deploying the generated WebLogic domain.
* [Sample for creating a WebLogic Deploy Tool model inside a Docker image (Model in Image)](https://oracle.github.io/weblogic-kubernetes-operator/samples/simple/domains/model-in-image/), and the domain resource YAML file for deploying the generated WebLogic domain.
