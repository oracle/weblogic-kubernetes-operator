# Copyright (c) 2014, 2019, Oracle Corporation and/or its affiliates.  All rights reserved.
...
while i < len(sys.argv):
    if sys.argv[i] == '-oh':
        ...
        i += 2
    elif sys.argv[i] == '-useKSSForDemo':
        useKSSForDemo = sys.argv[i + 1]
        i += 2
