...
public class CreateDomainGeneratedFilesVoyagerTest
  ...
  @Test
  public void generatesCorrect_loadBalancerAuthDelegatorClusterRoleBinding() throws Exception {
    assertThat(
  ...
  @Test
  public void generatesCorrect_loadBalancerAppsCodeEditClusterRole() throws Exception {
    assertThat(
  ...
  @Test
  public void generatesCorrect_loadBalancerAppsCodeVidwClusterRole() throws Exception {
    assertThat(
