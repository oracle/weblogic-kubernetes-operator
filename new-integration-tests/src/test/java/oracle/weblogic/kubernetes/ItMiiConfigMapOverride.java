...
class ItMiiConfigMapOverride implements LoggedTest {
  ...
  private static V1ConfigMap configMap = null;
  ...
  /**
   * Deploy a WebLogic domain in model-in-image 
   * Update configuration/model/configmap section of domain resource with 
   *  a configmap that define a JDBC datasource targeted to the cluster
   * Update the restartVersion of domain resource to a newer value to trigger 
   *  the rolling restart of the domain 
  */
  @Test
  @Order(1)
