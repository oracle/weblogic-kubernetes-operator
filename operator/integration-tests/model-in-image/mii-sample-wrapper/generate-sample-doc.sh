...
#      - A generated domain resource does
...
#
# Copy over the sample to WORKDIR, but don't keep the domain yaml resources (we will regenerate them)
#
...
#
# Assert that generated domain resource
