...
public class FilterPriorities {
   ...
   */
  public static final int ERROR_FILTER_PRIORITY = Priorities.ENTITY_CODER; // after entities are converted to json

  /**
   * The request debug logging filter's priority.
   */
  public static final int REQUEST_DEBUG_LOGGING_FILTER_PRIORITY = CSRF_PROTECTION_FILTER_PRIORITY + 200; // after the CSRF filter

  /**
   * The response debug logging filter's priority.
   */
  public static final int RESPONSE_DEBUG_LOGGING_FILTER_PRIORITY = ERROR_FILTER_PRIORITY + 200; // after the error filter
