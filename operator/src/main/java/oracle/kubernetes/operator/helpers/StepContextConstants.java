...
public interface StepContextConstants {
  ...
  String WEBLOGIC_CREDENTIALS_VOLUME = "weblogic-credentials-volume";
  ...
  String SECRETS_MOUNT_PATH = "/weblogic-operator/tmpfs/secrets";
  String OPSS_KEY_MOUNT_PATH = "/weblogic-operator/tmpfs/opss-walletkey-secret";
  String WDT_MODEL_ENCRYPTION_PASSPHRASE_MOUNT_PATH = "/weblogic-operator/tmpfs/wdt-encryption-passphrase";
  String RUNTIME_ENCRYPTION_SECRET_MOUNT_PATH = "/weblogic-operator/tmpfs/model-runtime-secret";
  String OVERRIDE_SECRETS_MOUNT_PATH = "/weblogic-operator/tmpfs/config-overrides-secrets";
  ...
  String OPSS_WALLETFILE_MOUNT_PATH = "/weblogic-operator/tmpfs/opss-walletfile-secret";
