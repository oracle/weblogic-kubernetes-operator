...
public interface StepContextConstants {
  ...
  static final String MODEL_IN_IMAGE_PASSPHRASE_VOLUME = "model-in-image-keypass-volume";
  ...
  static final String MODEL_IN_IMAGE_KEY_MOUNT_PATH = "/weblogic-operator/model-in-image-key-passphrase";
