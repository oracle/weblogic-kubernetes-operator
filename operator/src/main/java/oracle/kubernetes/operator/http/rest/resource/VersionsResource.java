...
import oracle.kubernetes.operator.http.rest.backend.VersionUtils;
import oracle.kubernetes.operator.http.rest.model.CollectionModel;
import oracle.kubernetes.operator.http.rest.model.VersionModel;
