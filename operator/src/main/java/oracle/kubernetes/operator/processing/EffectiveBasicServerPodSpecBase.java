...
public abstract class EffectiveBasicServerPodSpecBase implements EffectiveBasicServerPodSpec {

  protected final DomainSpec domainSpec;

  protected EffectiveBasicServerPodSpecBase(DomainSpec domainSpec) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof EffectiveBasicServerPodSpecBase)) {
      return false;
    }

    EffectiveBasicServerPodSpecBase that = (EffectiveBasicServerPodSpecBase) o;
