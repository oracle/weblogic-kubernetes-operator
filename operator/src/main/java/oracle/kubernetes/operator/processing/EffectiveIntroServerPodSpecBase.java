...
public abstract class EffectiveIntroServerPodSpecBase implements EffectiveIntroServerPodSpec {

  protected final DomainSpec domainSpec;

  protected EffectiveIntroServerPodSpecBase(DomainSpec domainSpec) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof EffectiveIntroServerPodSpecBase)) {
      return false;
    }

    EffectiveIntroServerPodSpecBase that = (EffectiveIntroServerPodSpecBase) o;
