...
public class VersionModel extends ItemModel {
   ...
   * @param lifecycle - the lifecycle of this version of the WebLogic operator REST api,
   * either 'activate' or 'deprecated'.
   */
  ...
  protected String propertiesToString() {
    return "version=" + getVersion() + ", latest=" + isLatest() + ", lifecycle=" + getLifecycle() + ", " + super.propertiesToString();
  }
}
