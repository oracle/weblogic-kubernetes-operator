...
/**
 * VersionsResource is a jaxrs resource that implements the REST api for the
 * /operator path.
 * It is the root resource of the WebLogic operator REST api and can be used to
 * list the available versions of the WebLogic operator REST api.
 */
@Path("operator")
public class VersionsResource extends BaseResource {
   ...
   * @return the version resource, throws a WebApplicationException if
