...
public class DeleteServiceListStep extends AbstractListStep<V1Service> {
  ...
  Step createActionStep(CoreDelegate delegate, V1Service service) {
    V1ObjectMeta meta = service.getMetadata();
    return delegate.getServiceBuilder().delete(meta.getNamespace(), meta.getName(), new DefaultResponseStep<>(this));
  }
}
