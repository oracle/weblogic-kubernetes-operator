...
public interface IntroServerPodConfigurator {
  IntroServerPodConfigurator withEnvironmentVariable(String name, String value);

  IntroServerPodConfigurator withEnvironmentVariable(V1EnvVar envVar);
   ...
   * @return this object
   */
  IntroServerPodConfigurator withRequestRequirement(String resource, String quantity);
   ...
   * @return this object
   */
  IntroServerPodConfigurator withLimitRequirement(String resource, String quantity);

  IntroServerPodConfigurator withPodLabel(String name, String value);

  IntroServerPodConfigurator withPodAnnotation(String name, String value);
}
