...
public class IntrospectorJobEnvVars {
   ...
   */
  public static final String ISTIO_REPLICATION_CHANNEL_PORT = "ISTIO_REPLICATION_CHANNEL_PORT";
  ...
  private static final List<String> RESERVED_NAMES = Arrays.asList(
      ...
      ISTIO_REPLICATION_CHANNEL_PORT, ISTIO_VERSION, ISTIO_POD_NAMESPACE, WDT_MODEL_HOME, MII_USE_ONLINE_UPDATE,
