...
public class ServerEnvVars {
  ...
  public static final String HASHICORP_K8S_ROLE = "HASHICORP_K8S_ROLE";

  public static final String HASHICORP_VAULT_URL = "HASHICORP_VAULT_URL";

  public static final String HASHICORP_SECRET_PATH = "HASHICORP_SECRET_PATH";
  ...
  private static final List<String> RESERVED_NAMES = Arrays.asList(
        ...
        LOG_HOME, SERVER_OUT_IN_POD_LOG, DATA_HOME, ACCESS_LOG_IN_LOG_HOME, DYNAMIC_CONFIG_OVERRIDE,
          DOMAIN_HOME_ON_PV_DEFAULT_UGID, KUBERNETES_PLATFORM, HASHICORP_K8S_ROLE, HASHICORP_VAULT_URL,
