...
checkDomainSecretMD5()
{
  ...
  if [ ! -f "$orig_md5_file" ]; then
    trace SEVERE "Missing file '$orig_md5_file'. The introspector job should have generated this file."
    return 1
  fi
