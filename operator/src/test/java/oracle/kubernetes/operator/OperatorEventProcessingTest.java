...
public class OperatorEventProcessingTest {
  ...
  public void onNewDomainCreatedEventWithNoInvolvedObject_doNothing() {
    V1Event event = createDomainEvent(".acbd1", DOMAIN_CREATED, "", null);
  ...
  public void onNewDomainCreatedEvent_updateKubernetesEventObjectsMap() {
    V1Event event = createDomainEvent(".acbd2", DOMAIN_CREATED, "", domainReference);
    dispatchAddedEventWatch(event);
  ...
  public void afterOnAddDomainCreatedEvent_onDeleteDomainCreatedEventWithNoInvolvedObject_doNothing() {
    V1Event event1 = createDomainEvent(".acbd3", DOMAIN_CREATED, "", domainReference);
    dispatchAddedEventWatch(event1);
    V1Event event2 = createDomainEvent(".acbd3", DOMAIN_CREATED, "", null);
  ...
  public void afterOnAddDomainCreatedEvent_onDeleteDomainCreatedEvent_updateKubernetesEventObjectsMap() {
    V1Event event = createDomainEvent(".acbd4", DOMAIN_CREATED, "", domainReference);
    dispatchAddedEventWatch(event);
  ...
  public void afterOnAddDomainCreatedEvent_onModifyDomainCreatedEventWithNoInvolvedObject_doNothing() {
    V1Event event1 = createDomainEvent(".acbd5", DOMAIN_CREATED, "", domainReference);
    dispatchAddedEventWatch(event1);
    V1Event event2 = createDomainEvent(".acbd5", DOMAIN_CREATED, "", null);
  ...
  public void afterOnAddDomainCreatedEvent_onModifyDomainDeletedEvent_updateKubernetesEventObjectsMap() {
    V1Event event = createDomainEvent(".acbd6", DOMAIN_CREATED, "", domainReference);
    dispatchAddedEventWatch(event);
  ...
  public void onNewDomainProcessingFailedEventWithNoInvolvedObject_doNothing() {
    V1Event event = createDomainEvent(".acbd7", DOMAIN_PROCESSING_FAILED, "failure", null);
    dispatchAddedEventWatch(event);
  ...
  public void onNewProcessingFailedEvent_updateKubernetesEventObjectsMap() {
    V1Event event = createDomainEvent(".acbd8", DOMAIN_PROCESSING_FAILED, "failure2", domainReference);
    dispatchAddedEventWatch(event);
  ...
  public void afterAddProcessingFailedEvent_onDeleteDomainProcessingFailedEventWithNoInvolvedObject_doNothing() {
    V1Event event1 = createDomainEvent(".acbd9", DOMAIN_PROCESSING_FAILED, "failureOnDelete1", domainReference);
    dispatchAddedEventWatch(event1);
  ...
  public void afterAddProcessingFailedEvent_onDeleteDomainProcessingFailedEvent_updateKubernetesEventObjectsMap() {
    V1Event event = createDomainEvent(".acbd10", DOMAIN_PROCESSING_FAILED, "failureOnDelete2", domainReference);
    dispatchAddedEventWatch(event);
    dispatchDeletedEventWatch(event);
    assertThat(getMatchingEvent(event), nullValue());
  }
  ...
  public void afterAddProcessingFailedEvent_onModifyDomainProcessingFailedEventWithNoInvolvedObject_doNothing() {
    V1Event event1 = createDomainEvent(".acbd11", DOMAIN_PROCESSING_FAILED, "failureOnModify1", domainReference);
    dispatchAddedEventWatch(event1);
    V1Event event2 = createDomainEvent(".acbd11", DOMAIN_PROCESSING_FAILED, "failureOnModify1", null);
    dispatchModifiedEventWatch(event2);
    assertThat(getMatchingEventCount(event1), equalTo(1));
  }
  ...
  public void afterAddProcessingFailedEvent_onModifyDomainProcessingFailedEvent_updateKubernetesEventObjectsMap() {
    V1Event event1 = createDomainEvent(".acbd12", DOMAIN_PROCESSING_FAILED, "failureOnModify2", domainReference);
    dispatchAddedEventWatch(event1);
    V1Event event2 = createDomainEvent(".acbd12", DOMAIN_PROCESSING_FAILED, "failureOnModify2", domainReference, 2);
    dispatchModifiedEventWatch(event2);
  ...
  public void afterAddDProcessingFailedEvent_onNewNamespaceWatchingStoppedEventWithNoInvolvedObject_doNothing() {
    V1Event event = createDomainEvent(".1234a", NAMESPACE_WATCHING_STOPPED, "", null);
    dispatchAddedEventWatch(event);
    assertThat(getMatchingEvent(event), nullValue());
  }
  ...
  public void onNewNamespaceWatchingStoppedEvent_updateKubernetesEventObjectsMap() {
    V1Event event = createNamespaceEvent(".1234b", NAMESPACE_WATCHING_STOPPED, nsReference);
    dispatchAddedEventWatch(event);
    assertThat(getMatchingEvent(event), notNullValue());
  }
  ...
  public void afterAddNSWatchingStoppedEvent_onDeleteNamespaceWatchingStoppedEventWithNoInvolvedObject_doNothing() {
    V1Event event1 = createNamespaceEvent(".1234c", NAMESPACE_WATCHING_STOPPED, nsReference);
    dispatchAddedEventWatch(event1);
    V1Event event2 = createNamespaceEvent(".1234c", NAMESPACE_WATCHING_STOPPED,null);
    dispatchDeletedEventWatch(event2);
    assertThat(getMatchingEvent(event1), notNullValue());
  }
  ...
  public void afterAddNSWatchingStoppedEvent_onDeleteNamespaceWatchingStoppedEvent_updateKubernetesEventObjectsMap() {
    V1Event event1 = createNamespaceEvent(".1234d", NAMESPACE_WATCHING_STOPPED, nsReference);
    dispatchAddedEventWatch(event1);
    V1Event event2 = createNamespaceEvent(".1234d", NAMESPACE_WATCHING_STOPPED, nsReference);
    dispatchDeletedEventWatch(event2);
  ...
  public void afterAddNSWatchingStoppedEvent_onModifyNamespaceWatchingStoppedEventWithNoInvolvedObject_doNothing() {
    V1Event event1 = createNamespaceEvent(".1234e", NAMESPACE_WATCHING_STOPPED, nsReference);
    dispatchAddedEventWatch(event1);
    V1Event event2 = createNamespaceEvent(".1234e", NAMESPACE_WATCHING_STOPPED,null);
    dispatchModifiedEventWatch(event2);
    assertThat(getMatchingEventCount(event1), equalTo(1));
  }
  ...
  public void afterAddNSWatchingStoppedEvent_onModifyNamespaceWatchingStoppedEvent_updateKubernetesEventObjectsMap() {
    V1Event event1 = createNamespaceEvent(".1234f", NAMESPACE_WATCHING_STOPPED, nsReference);
    dispatchAddedEventWatch(event1);
    V1Event event2 = createNamespaceEvent(".1234f", NAMESPACE_WATCHING_STOPPED, nsReference, 2);
    dispatchModifiedEventWatch(event2);
    assertThat(getMatchingEventCount(event1), equalTo(2));
  }
  ...
  public void onCreateStartManagingNSEvent_updateKubernetesEventObjectsMap() {
    V1Event event = createNamespaceEvent(".aaaa1", START_MANAGING_NAMESPACE, opReference);
    dispatchAddedEventWatch(event);
  ...
  public void afterAddStopManagingNSEvent_onModifyStopManagingNamespace_updateKubernetesEventObjectsMap() {
    V1Event event1 = createNamespaceEvent(".aaaa2", STOP_MANAGING_NAMESPACE, opReference);
    dispatchAddedEventWatch(event1);
    V1Event event2 = createNamespaceEvent(".aaaa2", STOP_MANAGING_NAMESPACE, opReference, 2);
    dispatchModifiedEventWatch(event2);
    assertThat(getMatchingEventCount(event1), equalTo(2));
  }
  ...
  public void afterAddStartManagingNSEvent_onDeleteTheEventWithNoInvolvedObject_doNothing() {
    V1Event event1 = createNamespaceEvent(".aaaa3", START_MANAGING_NAMESPACE, opReference);
    dispatchAddedEventWatch(event1);
    V1Event event2 = createNamespaceEvent(".aaaa3", START_MANAGING_NAMESPACE, null);
    dispatchDeletedEventWatch(event2);
    assertThat(getMatchingEvent(event1), notNullValue());
  }
  ...
  public void afterAddStopManaingNSEvent_onDeleteEvent_updateKubernetesEventObjectsMap() {
    V1Event event1 = createNamespaceEvent(".1234d", STOP_MANAGING_NAMESPACE, opReference);
    dispatchAddedEventWatch(event1);
    V1Event event2 = createNamespaceEvent(".1234d", STOP_MANAGING_NAMESPACE, opReference);
    dispatchDeletedEventWatch(event2);
    assertThat(getMatchingEvent(event1), nullValue());
  }

  private int getMatchingEventCount(V1Event event) {
    return Optional.ofNullable(getMatchingEvent(event)).map(V1Event::getCount).orElse(0);
  }

  private V1Event getMatchingEvent(V1Event event) {
    V1Event found = Optional.ofNullable(getEventK8SObjects(event)).map(k -> k.getExistingEvent(event)).orElse(null);
    return getEventName(found).equals(getEventName(event)) ? found : null;
  }

  @NotNull
  private String getEventName(V1Event event) {
  ...
  private void dispatchModifiedEventWatch(V1Event event) {
  ...
  private V1Event createDomainEvent(
  ...
  private V1Event createNamespaceEvent(String nameAppendix, EventItem item, V1ObjectReference involvedObj) {
  ...
  private V1Event createNamespaceEvent(String name, EventItem item, V1ObjectReference involvedObj, int count) {
