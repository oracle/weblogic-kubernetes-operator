...
class PodPresenceTest {
  ...
  public void setUp() throws Exception {
    ...
    // packet.getComponents().put(DELEGATE_COMPONENT_NAME, Component.createFor(processorDelegate));
  ...
  static class ConstantTestHash implements Function<Object, String> {
    public static Memento install() throws NoSuchFieldException {
      return StaticStubSupport.install(AnnotationHelper.class, "HASH_FUNCTION", new ConstantTestHash());
    }
