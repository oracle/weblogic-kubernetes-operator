  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(
        new Object[][] {
          ...
          {LOG_MSG_TEST, "1", "7", "1+coreos.0", containsWarning(K8S_VERSION_TOO_LOW), noIgnores()},
          {LOG_MSG_TEST, "1", "7", "5+coreos.0", containsInfo(K8S_VERSION_CHECK), noIgnores()},
          {VERSION_TEST, "1", "8", "3", returnsVersion(1, 8), ignoring(K8S_VERSION_CHECK)},
          {LOG_MSG_TEST, "1", "8", "3", containsInfo(K8S_VERSION_CHECK), noIgnores()},
