...
public class DomainV2Test extends DomainTestBase {
  ...
  public void whenDistributionStrategySpecified_readIt() throws IOException {
    ...
    assertThat(domain.getConfigOverrideDistributionStrategy(), equalTo(ConfigOverrideDistributionStrategy.ROLLING));
  }

  @Test
  public void whenDistributionStrategyConfigured_returnIt() {
    configureDomain(domain).withConfigOverrideDistributionStrategy(ConfigOverrideDistributionStrategy.ROLLING);
