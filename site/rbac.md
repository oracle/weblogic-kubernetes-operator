...
| --- | --- | --- | --- |
| `NAMESPACE-cluster-role` |	namespaces, persistentvolumes	| get, list, watch | 1 |
...
| `NAMESPACE-cluster-role-nonresource`	| nonResourceURLs: ["/version/*"]	| get |	1 |
|`NAMESPACE-namespace-role`	| secrets, persistentvolumeclaims	| get, list, watch	| 2 |
