...
For sample YAML templates, see the [Domain resource example](https://github.com/oracle/weblogic-kubernetes-operator/tree/master/kubernetes/samples/scripts/create-weblogic-domain-pv-pvc/README.md).
