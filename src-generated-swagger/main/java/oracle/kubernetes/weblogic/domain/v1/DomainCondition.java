...
public class DomainCondition {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("lastProbeTime", lastProbeTime).append("lastTransitionTime", lastTransitionTime).append("message", message).append("reason", reason).append("status", status).append("type", type).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(reason).append(lastTransitionTime).append(message).append(type).append(lastProbeTime).append(status).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(reason, rhs.reason).append(lastTransitionTime, rhs.lastTransitionTime).append(message, rhs.message).append(type, rhs.type).append(lastProbeTime, rhs.lastProbeTime).append(status, rhs.status).isEquals();
    }
