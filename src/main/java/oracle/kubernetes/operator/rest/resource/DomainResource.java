 ...
 * /operator/{version}/domains/{domainUID} path.
 * It can be used to describe a WebLogic domain that the WebLogic operator manages
 * and to traverse to its child resources.
 */
