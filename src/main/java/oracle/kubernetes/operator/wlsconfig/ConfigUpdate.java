...
/**
 * Each ConfigUpdate contains a suggested WebLogic configuration update that is necessary
 * to make the WebLogic configuration to be compatible with the DomainSpec configuration.
 */
