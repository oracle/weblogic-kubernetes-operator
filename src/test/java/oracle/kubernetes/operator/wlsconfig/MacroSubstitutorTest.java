...
public class MacroSubstitutorTest {
  ...
  public void testMacros(){
    ...
    final MacroSubstitutor MACRO_SUBSTITUTOR = new MacroSubstitutor(ID, SERVER, CLUSTER, DOMAIN, MACHINE);
    ...
    assertEquals(
            ...
            null,
            MACRO_SUBSTITUTOR.substituteMacro(null)
    );
    ...
    assertEquals(
            "string with only macro",
            SERVER,
            MACRO_SUBSTITUTOR.substituteMacro("${serverName}")
    );
    ...
    assertEquals(
            "string without complete macro",
            "test${",
            MACRO_SUBSTITUTOR.substituteMacro("test${")
    );
