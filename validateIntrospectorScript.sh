...
if [ -z "${DOMAIN_INTROSPECTION_COMPLETE_STRING}" ]; then
  printf "Failed to find the value of DOMAIN_INTROSPECTION_COMPLETE constant in ProcessingConstants.java file.\n"
  exit 1
fi
